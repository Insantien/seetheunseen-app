      ...
      <div className="hidden lg:flex lg:w-1/2 relative flex-col items-center justify-center bg-gradient-to-br from-slate-900 via-stone-900 to-brand-dark overflow-hidden">
        ...
        <div className="relative z-10 max-w-md px-12 text-center">
          ...
          <blockquote className="font-lora text-xl leading-relaxed text-white/80">
            Every journey begins with a single step — and behind every great journey
            is a traveller who dared to see the world differently.
          </blockquote>
      ...
      <div className="flex-1 flex items-center justify-center bg-white px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <p className="text-brand-grey text-sm mb-8">
            Create a free account to save tours, track enquiries and more
          </p>
          ...
          <div className="relative flex items-center gap-4 mb-6">
            ...
            <span className="text-xs text-brand-grey">or sign up with email</span>
            <div className="flex-1 h-px bg-gray-200" />
          </div>
          ...
          {isSent ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                >
                  Phone number{" "}
                  <span className="text-brand-grey font-normal">(optional)</span>
                </label>
                <input
                  id="phone"
                  type="tel"
              ...
              <label className="flex items-start gap-3 cursor-pointer">
                <input
                  ...
                  className="mt-0.5 h-4 w-4 rounded border-gray-300 accent-brand-orange"
                />
              ...
              <Button
                ...
                disabled={!email || !agreed || isLoading !== null}
              >
                Create Account
              </Button>
            </form>
